...
namespace Data.Factories {
    public class DoorFactory {
        private readonly Dictionary<string, Func<DoorDTO, IDoor, IDoor>> doorDecorators = new Dictionary<string, Func<DoorDTO, IDoor, IDoor>> {
        ...
        public IDoor Create(DoorDTO[] dtos) {
